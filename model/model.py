...
class NNUEModel(nn.Module):
    def __init__(
        ...
        self.input = ComposedFeatureTransformer(feature_cls, self.L1, self.quantization)
    ...
    def forward(
        ...
        x = self.layer_stacks(l0_, layer_stack_indices, fake_quantize_acts, fake_quantize_weights)
